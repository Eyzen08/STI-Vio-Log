...
const reviewSections = [
  ...
  { title:'Guardian Contact Information',step:2,rows:[['Guardian Full Name','guardianName'],['Relationship','guardianRelationship'],['Guardian Contact Number','guardianPhoneNumber']] },
...
export default function StudentPasswordAccess({ routePath, onNavigate }) {
  ...
  const registrationPanel=()=>{
    ...
    if(registrationStep===2)return <div className="registration-field-grid">{field('guardianName','Guardian Full Name','Maria Reyes')}{field('guardianRelationship','Relationship','Mother')}{field('guardianPhoneNumber','Guardian Contact Number','09181234567',{autoComplete:'tel',inputMode:'tel'})}</div>
