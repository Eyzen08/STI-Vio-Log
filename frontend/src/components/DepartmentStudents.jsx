...
function DepartmentStudents({ report, loading, error, onOpenDtr }) {
  ...
  return (
    <div className="department-students-page">
      ...
      <p className="scope-note">This roster includes only students with attendance in your authenticated department. Private Guardian Contact details are restricted to authorized Administration and Discipline Office staff.</p>
    </div>
  )
}
