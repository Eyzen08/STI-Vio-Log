...
export const APP_ROUTES = [
  ...
  { path: '/admin/registrations', label: 'Duplicate Review', view: 'Duplicate Review', roles: ['DISCIPLINE_ADMIN'], navigation: false, redirectTo: '/admin/duplicate-review' },
  ...
  { path: '/admin/duplicate-review', label: 'Duplicate Review', view: 'Duplicate Review', roles: ['DISCIPLINE_ADMIN'] },
