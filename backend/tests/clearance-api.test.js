...
test('clearance routes expose full CRUD surface', () => {
  ...
  for (const [path, method] of [['/certificates/eligible','get'],['/certificates/students','get'],['/certificates/students/:studentId/approve','post'],['/certificates','get'],['/certificates','post'],['/certificates/:id/pdf','get'],['/certificates/:id/revoke','post'],['/certificates/:id/email','post'],['/signatures','get'],['/signatures','post'],['/signatures/:id','put']]) {
