...
const allowedCategories = new Set(['SYSTEM', 'ATTENDANCE', 'VIOLATIONS', 'COMMUNITY_SERVICE', 'CLEARANCE', 'MESSAGES'])
...
const getMyNotifications = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `SELECT id,title,message,notification_type,category,resource_type,resource_id,link_path,metadata,is_read,read_at,created_at
...
module.exports = { getMyNotifications, markMyNotificationRead, markAllMyNotificationsRead }
